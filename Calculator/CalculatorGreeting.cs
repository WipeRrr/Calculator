...
namespace Calculator
{
    internal class CalculatorGreeting
    {
        ...
        public static void DisplayGreeting(IOutputter Outputter, Constants constants)
        {
            ...
            Outputter.WriteLine($"Supported operators: {constants.GetAllOperators()}\nr(root,just write r after digit),%(remainder of division)");
